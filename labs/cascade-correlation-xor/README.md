...
For broader context, use the literature garden's [algorithm overview](../../pages/algorithms.html) and [Cascade-Correlation Growth Walkthrough](../../modules/cascade-correlation-growth/). The walkthrough links back to this runnable trace.
