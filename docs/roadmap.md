...
- [x] Project skeleton
- [x] Integrated review/lab remit document
...
- Portfolio-selected work improves one bounded artifact and commits locally, but never pushes from unattended execution.
- Labs use repository-local links to the literature layer rather than duplicating its paper reviews.
